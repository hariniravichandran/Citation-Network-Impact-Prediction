...
def getCitations():
    ...
    for pubId in pubs:
        ...
        for reference in references:
            if reference in pubs:
                if 'citedPubs' not in pubs[reference]:
                    pubs[reference]['citedBy'] = []
                pubs[reference]['citedBy'].append(pubId)
...
init()
populatePublicationDict('./testData.txt')
#populatePublicationDict('/Users/agalya/Documents/sml/project/datasets/DBLP_Citation_2014_May/domains/Artificial intelligence.txt')
